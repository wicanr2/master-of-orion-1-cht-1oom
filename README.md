...
| `docs/CJK-DEV-NOTES.md` | 繁中化工程筆記:技巧、踩雷與反思(實作 know-how) |
...
- [x] **烘字標籤 / 按鈕疊字**:研究(tab / 欄位標題)、種族、新遊戲、殖民地報表(撥款 / 確定)、艦隊(查看 / 拆解 / 確定)、銀河星圖(殖民 / 環境 / 礦產 / 確定 + 模式切換)、撥款與調動 / 飛彈基地拆解彈窗(取消 / 確定)按鈕全中文(共用 `ui_draw_btn_cjk` 取樣鈕面置中疊字)
