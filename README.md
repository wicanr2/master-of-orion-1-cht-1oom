...
- **面板標籤與按鈕**(銀河大小 / 難度 / 對手 / 取消 / 確定)— 這些字其實是**烘在 LBX 背景圖與按鈕圖裡的影像**,不是字串;以「取樣面板色蓋掉英文 + 疊上中文」的方式中文化,無需改動版權圖檔。

### 種族選擇

![種族選擇繁中](docs/img/milestone-race-cjk.png)

十大種族清單與種族特性全部中文:**人類 / 莫善 / 矽基 / 薩克拉 / 賽隆 / 阿卡里 / 克拉肯 / 布拉西 / 梅克拉 / 達洛克 / 隨機**,右側顯示所選種族特性(精明商人、兼卓越的、外交家)。清單列距已針對 24×24 中文加大,避免上下重疊。
...
| `docs/` | ADR、文字盤點、CJK 技術筆記 |
| `docs/wiki/` | 《銀河霸主》繁中**小百科**(概述 / 種族 / 科技 / 艦船戰鬥 / 策略 / 術語) |
| `CONTEXT.md` | 專案術語表 |
